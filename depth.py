...
def main():
    ...
    # file path argument
    parser.add_argument("img_dir", type=str, default='data/IMX219-83',
    ...
    if args.take_img == 'True':
        captureImage(left_pipeline, api=api,  save_dir=args.img_dir, img_name='img_l', show_img=False)
        captureImage(right_pipeline, api=api, save_dir=args.img_dir, img_name='img_r', show_img=False)
